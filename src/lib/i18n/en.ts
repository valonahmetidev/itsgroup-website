...
const en: Dictionary = {
  ...
  catalog: {
    ...
    addingToProforma:
      "You are building a saved proforma invoice — not your quote list. Products already on it show “On this proforma”. Use Save at the bottom when you are done.",
    saveProforma: "Save proforma",
    proformaItemCount: "{count} on this proforma",
    sourceLabel: "Catalog",
    sortLabel: "Sort by",
  ...
  customer: {
    ...
    proformaEditorNote:
      "This editor is only for saved proforma invoices. It does not change your quote list on /ponuda.",
    addProductsToProforma: "Add products from catalog",
    backToProformaEditor: "Back to proforma editor",
    proformaCatalogItemsAdded: "Products from the catalog were added. Save to keep them on this proforma invoice.",
    deleteProforma: "Delete",
    deleteProformaConfirm: "Delete this proforma invoice? This cannot be undone.",
  },
  product: {
    inStock: "In stock",
  ...
  quote: {
    ...
    quoteListNote:
      "This is your temporary quote list in this browser. Saved proforma invoices are managed separately under Profile.",
  ...
  admin: {
    ...
    proformaLineDiscount: "Discount %",
    proformaSubtotal: "Subtotal",
