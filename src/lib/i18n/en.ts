...
const en: Dictionary = {
  ...
  customer: {
    ...
    profileText: "Your details, discounts, and proformas from ITS Group.",
    myProformas: "My proformas",
    noProformas: "You have no proformas yet.",
    viewProforma: "View",
  ...
  quote: {
    ...
    proformaSaved: "Proforma saved. Open it from your profile.",
    signInToSaveProforma: "Sign in to save proformas to your account.",
  ...
  admin: {
    ...
    proformasCount: "Proformas",
    recentProformas: "Recent proformas",
    inquiryDate: "Date",
