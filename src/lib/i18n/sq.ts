...
const sq: Dictionary = {
  ...
  validation: {
    ...
    rateLimited: "Shumë kërkesa. Provoni përsëri më vonë.",
    databaseUnavailable: "Shërbimi është i padisponueshëm. Provoni përsëri ose na kontaktoni në WhatsApp.",
  },
  nav: {
  ...
  catalog: {
    ...
    addingToProforma:
      "Po ndërtoni një profaturë të ruajtur — jo listën e ofertës. Produktet e shtuara shfaqen këtu. Përdorni Ruaj në fund kur të mbaroni.",
    saveProforma: "Ruaj profaturën",
    proformaItemCount: "{count} në këtë profaturë",
  ...
  customer: {
    ...
    profileText: "Të dhënat, zbritjet dhe profaturat nga ITS Group.",
    myProformas: "Profaturat e mia",
    noProformas: "Ende nuk keni profatura.",
    viewProforma: "Shiko",
    generalDiscountLabel: "Zbritje e përgjithshme",
    openCatalog: "Katalog",
    openQuote: "Lista e ofertës",
    proformaDetail: "Profaturë",
    editProforma: "Ndrysho profaturën",
    proformaEditorNote:
      "Ky redaktues është vetëm për profatura të ruajtura. Nuk ndryshon listën e ofertës në /ponuda.",
    addProductsToProforma: "Shto produkte nga katalogu",
    backToProformaEditor: "Kthehu te redaktuesi i profaturës",
    proformaCatalogItemsAdded: "Produktet nga katalogu u shtuan. Ruajeni për t’i mbajtur në këtë profaturë.",
    deleteProforma: "Fshi",
    deleteProformaConfirm: "Të fshihet kjo profaturë? Nuk mund të kthehet.",
  },
  product: {
    inStock: "Në stok",
  ...
  quote: {
    ...
    text: "Shtoni produkte nga katalogu ynë në listën e ofertës. Shkarkoni profaturën (PDF) ose dërgoni listën përmes WhatsApp dhe ne do të konfirmojmë çmimin dhe disponueshmërinë.",
    ...
    sendingRequest: "Duke dërguar...",
    submitSuccess: "Kërkesa u pranua. Do t'ju kontaktojmë së shpejti.",
    customerDetails: "Të dhënat tuaja",
    company: "Kompania",
    itemsHeading: "Produktet",
    total: "Totali",
    proformaNote: "Kjo është një profaturë informative. Çmimi final dhe disponueshmëria konfirmohen nga ITS Group.",
    downloadPdf: "Shkarko profaturën (PDF)",
    saveProforma: "Ruaj profaturën",
    ...
    quoteListNote:
      "Kjo është lista e përkohshme e ofertës në këtë shfletues. Profaturat e ruajtura menaxhohen veçmas te Profili.",
  ...
  contact: {
    ...
    text: "Plotësoni formularin — do ta marrim kërkesën, dhe mund të vazhdoni edhe në WhatsApp.",
    domain: "Faqja web",
    email: "Email",
    phone: "Telefon",
    address: "Adresa",
    ...
    submitSuccess: "Faleminderit — e morëm mesazhin tuaj.",
    openWhatsApp: "Vazhdo në WhatsApp",
  },
  about: {
    title: "Rreth nesh",
    eyebrow: "ITS Group",
  ...
  admin: {
    ...
    proformaLineDiscount: "Zbritje %",
    proformaSubtotal: "Nëntotali",
    proformaDownloadPdf: "Shkarko profaturën (PDF)",
    proformaSave: "Ruaj",
    proformaDelete: "Fshi",
    ...
    inquiries: "Kërkesa",
    inquiriesText: "Mesazhe nga forma e kontaktit dhe lista ofertash nga faqja.",
    inquiryTypeContact: "Kontakt",
    inquiryTypeQuote: "Ofertë",
    inquiryStatusNew: "E re",
    inquiryStatusRead: "E lexuar",
    inquiryMarkRead: "Shëno si të lexuar",
    inquiryNoItems: "Nuk ka kërkesa.",
    inquiryView: "Detaje",
    inquiryPayload: "Artikujt e listës",
    newInquiries: "Kërkesa të reja",
    proformasCount: "Profatura",
    recentProformas: "Profaturat e fundit",
    inquiryDate: "Data",
    inquiryMessage: "Mesazh",
  },
};
