...
const sq: Dictionary = {
  ...
  customer: {
    ...
    profileText: "Të dhënat, zbritjet dhe proformat nga ITS Group.",
    myProformas: "Proformat e mia",
    noProformas: "Ende nuk keni proforma.",
    viewProforma: "Shiko",
    generalDiscountLabel: "Zbritje e përgjithshme",
    openCatalog: "Katalog",
    openQuote: "Lista e ofertës",
    proformaDetail: "Proforma",
  },
  product: {
    inStock: "Në stok",
  ...
  quote: {
    ...
    saveProforma: "Ruaj proformën",
    savingProforma: "Duke ruajtur…",
    proformaSaved: "Proforma u ruajt. Hapeni nga profili juaj.",
    signInToSaveProforma: "Hyni për të ruajtur proforma në llogarinë tuaj.",
  ...
  admin: {
    ...
    proformasCount: "Proforma",
    recentProformas: "Proformat e fundit",
    inquiryDate: "Data",
