...
function contentSecurityPolicy() {
  ...
  return [
    ...
    "img-src 'self' data: blob: https://treco.mk https://www.treco.mk https://tremark.mk https://www.tremark.mk https://www.google-analytics.com https://www.googletagmanager.com",
    "font-src 'self'",
