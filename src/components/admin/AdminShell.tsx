      ...
      <header className="border-b border-ink/10 bg-card">
        <div className="shell flex flex-wrap items-center justify-between gap-4 py-4">
          <div>
            ...
            <h1 className="font-display text-2xl">{dict.admin.panel}</h1>
          </div>
          ...
          <nav className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="rounded-full border border-ink/10 px-4 py-2 text-sm font-medium hover:border-home hover:text-home"
            >
              {dict.admin.logout}
            </button>
          </nav>
